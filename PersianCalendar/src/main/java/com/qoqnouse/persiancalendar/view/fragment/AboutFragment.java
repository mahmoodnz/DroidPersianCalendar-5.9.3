...
import com.qoqnouse.persiancalendar.databinding.FragmentAboutBinding;
...
public class AboutFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        binding.email.setOnClickListener(arg -> {
            Intent emailIntent = new Intent(Intent.ACTION_SENDTO, Uri.fromParts("mailto", "andersonmahmood72@gmail.com\n", null));
